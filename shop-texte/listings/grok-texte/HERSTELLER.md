...
- `hanfjack-de-hersteller.json` – alle 183 Hersteller mit Anschrift und EU-Verantwortlichem
- `hanfjack-de-hersteller.csv` – dieselben Daten als Tabelle

## Geprüft wurde auf

Die Angaben nach der EU-Produktsicherheitsverordnung (GPSR, VO (EU) 2023/988):

| Prüfung | |
| --- | --- |
| A | Herstellerangabe überhaupt vorhanden |
| B | Postleitzahl vorhanden |
| C | elektronische Kontaktadresse (E-Mail oder Website) vorhanden |
| D | Land angegeben |
| E | bei Herstellern außerhalb der EU: verantwortliche Person in der EU benannt |
...
### Vorher ganz ohne Herstellerangabe

| Hersteller | Ergänzt | Quelle |
| --- | --- | --- |
| Grow In AG | vollständige Anschrift, Telefon, E-Mail, Web | growin.de/legal-notice, HRB 105569B |
| GrowTechnology GmbH | vollständige Anschrift, Telefon, E-Mail, Web | growtechnology.de/impressum, HRB 730850 |
| GREEN WORKS GmbH | vollständige Anschrift, Telefon, E-Mail, Web | bobby-green.com/impressum, HRB 92760 |
| Pyramid Seeds | Imagine Grow SL, Anschrift, CIF, Telefon, E-Mail | pyramidseeds.com, Terms & Conditions |
| hy-pro | Anschrift und Web | identisch mit dem gepflegten Term „Hy-Pro Fertilizers" |
| HGA International B.V. | Anschrift, KvK, Telefon, E-Mail, Web | hgagarden.com, KvK 69505772 |
| HPS | Anschrift, E-Mail, Web | aus den EU-Feldern von Nutriculture und House & Garden |
| Trimpro | Biofloral Inc., Anschrift, Telefon, E-Mail, Web | trimpro.ca |
| Ferrero | Ferrero Deutschland GmbH, Anschrift, Telefon, E-Mail | ferrero.com/de/de/impressum, HRB 74408 |
...
Keirton Inc., Villakha Enterprises Inc., Master Products Inoxidable S.L., Biohorti SLU (BioTabs),
Ruperts Farm SL (Anesia Seeds), Carson Optical, Senkap, Quest Climate, Mills Nutrients,
Rock Holdings Pty Ltd, Nutriculture.

### Veraltete oder fehlerhafte Angaben korrigiert

| Hersteller | Was war falsch |
| --- | --- |
| Green House Seed Co. | Anschrift veraltet – GHSC Trading B.V. sitzt jetzt Kabelweg 22, 1014 BB Amsterdam |
| Pollinator Company | Anschrift veraltet – jetzt Grasweg 41D, 1031 HW Amsterdam |
| Grodan | nur Postfach – durch die Besuchsanschrift Industrieweg 15, 6045 JG Roermond ersetzt |
| Green House Powder Feeding | nur Postfach – durch Keienbergweg 49, 1101 EX Amsterdam-Zuidoost ersetzt |
| Shenzhen Mei Zhi Guangdian | Schreibfehler „Shenzen", Postleitzahl 518115 fehlte |
| Wizard Trees | nur „Los Angeles, CA" – vollständige Anschrift aus der kalifornischen Lizenz C11-0001784-LIC |
| Nutriculture | EU-Verantwortlicher saß angeblich in der Île-de-France; Landerneau liegt in der Bretagne |
| Senkap | Komma-Fehler in der EU-Adresse |
| IPP | Komma-Fehler in der Adresse |
| 420z GmbH | Land fehlte |

### EU-Verantwortlicher ins richtige Feld verschoben

Bei fünf Herstellern stand die verantwortliche Person in der EU im Feld der Herstelleranschrift
...
- **House & Garden**: Eingetragen ist der australische Vertrieb Stealth Garden. Die im Shop
